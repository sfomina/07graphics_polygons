...
def make_vector(p1,p2):
    vector = []
    vector.append(p2[0] - p1[0])
    vector.append(p2[1] - p1[1])
    vector.append(p2[2] - p1[2])
    return vector


def cross_product(v1, v2):
    product = []
    product.append(v1[1]*v2[2] - v1[2]*v2[1])
    product.append(v1[2]*v2[0] - v1[0]*v2[2])
    product.append(v1[0]*v2[1] - v1[1]*v2[0])
    return product
