...
def add_sphere( edges, cx, cy, cz, r, step ):
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            index = lat * step + longt #top right

            
            if (lat == lat_stop - 1):
                bottom_right = longt
            else : 
                bottom_right  = (lat + 1) * step + longt
...
def add_torus( edges, cx, cy, cz, r0, r1, step ):
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            bottom_right = (index + longt_stop) % (lat_stop * longt_stop)
            top_right = (index + 1) % (lat_stop * longt_stop)
            bottom_left  = (index + longt_stop + 1) % (lat_stop * longt_stop)
